...
class Client(Protocol):
    ...
    async def send_echo(self,
                        stamp: int,
                        timeout: float = 0.0) -> protocol.EchoResponse | None:
        ...
...
class SynchronizedClock:
    ...
    def compute_latencies(self, data: protocol.FrameSuffixData,
                          t_c: int) -> tuple[int, int]:
        ...
        transmit_latency = t_c - self.server_ticks_to_client_time(
            data.stamp_transmit)
